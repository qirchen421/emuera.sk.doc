...
!!! info "API"
	...
	要使其产生动画效果，需要使用 [`SPRITEANIMEADDFRAME`](./SPRITEANIMEADDFRAME.zh.md) 指令添加帧。  
	关于动画精灵的注意事项，也请参阅 [`resouces`](../Emuera/resources.zh.md)。  
...
### 相关项目
- [SPRITEANIMEADDFRAME](SPRITEANIMEADDFRAME.zh.md)
- [SETANIMETIMER](SETANIMETIMER.zh.md)