...
!!! info "API"
	...
	所有其他规范均与 [`SETCOLOR`](./SETCOLOR.zh.md) 和 [`SETBGCOLOR`](./SETBGCOLOR.zh.md) 相同。参数为颜色名称。预定义的颜色名称遵循 [KnownColor 枚举](https://learn.microsoft.com/ja-jp/dotnet/api/system.drawing.knowncolor)，请参考该文档。
