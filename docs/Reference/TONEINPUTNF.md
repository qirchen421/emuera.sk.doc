...
| 関数名                                                              | 引数                                   | 戻り値   |
| :------------------------------------------------------------------ | :------------------------------------- | :------- |
| ![](../assets/images/IconEmuera.webp)[`TONEINPUTNF`](./TONEINPUTNF.md)  | `int`, `int`(, `int`, `string`, `int`) | `int`    |
| ![](../assets/images/IconEmuera.webp)[`TONEINPUTSNF`](./TONEINPUTNF.md) | `int`, `string`(, `int`, `string`, `int`) | `string` |
...
!!! info "API"
    ...
    ```
    [`TONEINPUT`](TONEINPUT.md) / [`TONEINPUTS`](TONEINPUT.md) と全く同じ機能ですが、**強制スクロールを行いません**。
    ...
    - ✅ タイムアウト機構は元の TONEINPUT と同じ

    引数と戻り値は元のバージョンと全く同じです。[`TONEINPUT`](TONEINPUT.md) / [`TONEINPUTS`](TONEINPUT.md) を参照してください。
