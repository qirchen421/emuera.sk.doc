...
| 函数名                                                              | 参数                                   | 返回值   |
| :------------------------------------------------------------------ | :------------------------------------- | :------- |
| ![](../assets/images/IconEmuera.webp)[`TONEINPUTNF`](./TONEINPUTNF.zh.md)  | `int`, `int`(, `int`, `string`, `int`) | `int`    |
| ![](../assets/images/IconEmuera.webp)[`TONEINPUTSNF`](./TONEINPUTNF.zh.md) | `int`, `string`(, `int`, `string`, `int`) | `string` |
...
!!! info "API"
    ...
    ```
    与 [`TONEINPUT`](TONEINPUT.zh.md) / [`TONEINPUTS`](TONEINPUT.zh.md) 功能完全相同，但**不强制滚动到底部**。
    ...
    - ✅ 超时机制与原版 TONEINPUT 相同

    参数和返回值与原版完全一致，参见 [`TONEINPUT`](TONEINPUT.zh.md) / [`TONEINPUTS`](TONEINPUT.zh.md)。
