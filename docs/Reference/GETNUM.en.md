...
!!! info "API"
	...
	The correspondence between CSV and variables follows the "Array element specification by string" in the ["Syntax added in Emuera"](../Emuera/expression.en.md#string-array-element) page.
