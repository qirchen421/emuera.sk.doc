...
!!! info "API"
    ...
    此处设置的按钮映射会影响[`CBGSETBUTTONSPRITE`](./CBGSETBUTTONSPRITE.zh.md)命令及[`INPUTMOUSEKEY`](./INPUTMOUSEKEY.zh.md)命令。  
    按钮映射图像不会显示，但会像[`CBGSETG`](./CBGSETG.zh.md)命令设置的图像一样，使画面左下角与图像左下角对齐进行放置。  
