...
> **TO 系列类型转换函数的完整 API 文档**（TOSTR / TOSTRF / TOINT / TOFLOAT 的参数签名、格式字符串、示例代码），请参阅 [值、类型与变量 — 类型转换函数](../Reference/TOSTR.zh.md)。本节仅讨论与 FORM 语法直接相关的部分。
