...
=== "v15"
    ...
    * Functions added: [`DataTable` system functions](../Reference/DT_MANAGE.en.md).
...
=== "v12"
    ...
    * Specification change: Changed [XML system commands](../Reference/XML_MANAGE.en.md) to use string IDs, compatible with older versions.
